...
```sh
(venv) $ pip install dbt-core==1.8.9
```
...
Requires: agate, click, daff, dbt-adapters, dbt-common, dbt-extractor, dbt-semantic-interfaces, Jinja2, logbook, mashumaro, minimal-snowplow-tracker, networkx, packaging, pathspec, protobuf, pytz, pyyaml, requests, sqlparse, typing-extensions
